...
- CLI `python -m mclab batches <terms> --details` also prints playbook, latest history, worksheet, plot, plot-review, prediction-check, and handoff cues for terminal-only learners
