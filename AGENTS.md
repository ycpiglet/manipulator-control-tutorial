...
- Learner menu scenario and batch cards plus the live interaction panel include a `Playbook` line that turns each demo into predict, manipulate, and evidence-review steps
