...
- CLI `python -m mclab scenarios <terms> --details` also prints latest report/folder, history, mission/challenge evidence, observation/latest evidence, observation flow/next step, preset/activity mix, next cue, plot, worksheet, and replay status for terminal-only learners
