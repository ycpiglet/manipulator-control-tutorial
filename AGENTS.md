...
- Interactive `MCLab Interaction` observation area shows a persistent `Saved observation` recap after `Mark observation` so learners can confirm prediction, outcome, note, control, and preset evidence plus the next review or repair step
