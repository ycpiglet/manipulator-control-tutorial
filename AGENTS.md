...
- Batch reports and worksheets include a `Viewer Handoff` recommendation that picks a scenario to reopen in the side-panel-free viewer based on the largest baseline metric change, with report, priority-plot, worksheet, and folder links
