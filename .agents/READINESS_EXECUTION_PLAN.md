...
- 상태: **Execution baseline v11 — BASE-01 evidence 11/12; candidate PR and owner acceptance pending**
- 작성일: 2026-07-22 KST
...
- BASE-01 frozen subject/tree:
  `ae4d40371b9a3fe4d7078822e1fc541a72defe2d` /
  `b5f4cb03abbf1e66c14c27c720c737ef2fc4f798`
- BASE-01 evidence status: G1 **11/12 PASS**; exact subject and candidate PR
  head owner acceptance pending
...
| 6 | `agent/safe-main-baseline` / BASE-01 | 진행 중; evidence 11/12, candidate PR·owner acceptance pending | exact-subject 후보 선언서, 독립 review, exact-head 6/6, 명시적 owner acceptance |
...
- 현재 유일한 active merge lane은 BASE-01 candidate 기록, 독립 read-only review,
  exact-head six checks다. Signing/license/pilot 내부 준비는 병렬로 할 수 있지만
...
1. Frozen subject `ae4d40371b9a3fe4d7078822e1fc541a72defe2d`와 tree
   ...
   `CANDIDATE — owner acceptance pending`으로 기록한다.
2. G1 11/12와 유일한 미충족 항목인 exact-subject/exact-PR-head owner acceptance를
   명시한다. Dependency lock은 `N/A — SUP-01 pending`으로 기록하고 deferred
