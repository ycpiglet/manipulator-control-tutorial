...
- LIC-01A exact head/merge:
  `c707999a6f0299a9cc8bbf97f1f2ab22217b2011` /
  `0ed0efbf75ea2f66a7d3f761734c485a5265b632`
- LIC-01A source/merge tree:
  `aee1ee7ddb0840fd6517c0fefa40d5085788d7d2` — equivalence **PASS**
- LIC-01A exact-head runs: CI `29961923132`, desktop `29961923217`;
  post-merge runs: CI `29963046292`, desktop `29963046307` — required
  checks **6/6 PASS** at both SHAs
- LIC-01A status: **accepted only as the deterministic pending inventory
  contract**. It binds 49 package-lock candidates and 12 target cells, with
  three accepted hosted observations. `pending-lic-01`, legal approval false,
  notice completion false, Qt/PySide decision pending, and distribution
  closure unproven remain authoritative.
- PKG-01A exact head/merge:
  `aeabf3a852774fc198d56426f4cb507ada498f1d` /
  `96702b09d7e2b0e3b381b86c5e6e51f95682d346`
- PKG-01A source/merge tree:
  `2d897fa81506887df863106f118ddeb660880cfd` — equivalence **PASS**
- PKG-01A exact-head runs: CI `29968981476`, desktop `29968981517`;
  post-merge runs: CI `29969976213`, desktop `29969976169` — required
  checks **6/6 PASS** at both SHAs
- PKG-01A exact-head one-folder/archive bytes:
  Windows `259148501 / 93923818`, Ubuntu `342402649 / 123143362`,
  macOS `192875997 / 65943576`; both unchanged limits pass independently.
...
- E2E-01 Draft #70 exact head:
  ...
  Its bounded three-OS G2 JSON is candidate evidence only. The draft remains
  blocked because aggregate PKG-01 has not been accepted before E2E-01; it
  does not establish G2, B3, merge authority, or promotion authority.
