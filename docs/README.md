...
| Learner or shared-PC administrator / 학습자·공용 PC 관리자 | [Local data and privacy / 로컬 데이터와 개인정보](local_data_and_privacy.md) | Resolve effective local evidence/cache locations and review open shared-PC limits / effective 로컬 증거·cache 위치 확인과 공용 PC 미결 경계 검토 |
