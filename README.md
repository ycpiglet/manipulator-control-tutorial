...
`python -m mclab --help` prints the learner workflow for setup checking, opening the menu, checking coverage, previewing the next path step, and launching the next path step.
