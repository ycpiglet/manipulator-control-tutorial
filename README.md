...
| `.\run_lab04_wall_interactive.cmd` | Panda 손끝 `target X/Y/Z`, `wall X/stiffness/damping/retreat gain` 슬라이더, wall preset | 목표를 벽 안쪽으로 밀 때 Wall phase, penetration, force, retreat가 바뀌는 과정 |
...
| `.\run_lab04_wall_interactive.cmd` | Panda hand `target X/Y/Z`, `wall X/stiffness/damping/retreat gain` sliders, wall presets | how Wall phase, penetration, force, and retreat change when the target moves through the wall |
