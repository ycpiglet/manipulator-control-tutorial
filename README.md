...
- `worksheet.md`: `Mission`, `Done when` 완료 기준, mission evidence status와 next proof step, 예측, prediction outcome, pending outcome review, learner note, observation timeline, live status, 핵심 파라미터, Lab04 `Key Moments`, priority plot review, review checklist, suggested next experiment, comparison batch 명령을 Markdown으로 정리한 복습/제출용 워크시트
...
- `worksheet.md`: a Markdown review/submission worksheet with `Mission`, `Done when` completion criteria, mission evidence status and next proof step, predictions, prediction outcomes, pending outcome review, learner notes, observation timeline, live status, key parameters, Lab04 `Key Moments`, priority plot review prompts, a review checklist, suggested next experiments, and comparison batch commands
