...
- `worksheet.md`: 예측, prediction outcome, learner note, live status, 핵심 파라미터, review checklist를 Markdown으로 정리한 복습/제출용 워크시트
...
- `worksheet.md`: a Markdown review/submission worksheet with predictions, prediction outcomes, learner notes, live status, key parameters, and a review checklist
