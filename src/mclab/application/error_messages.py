...
_KO_DETAILS = {
    ...
    "active course comparison cannot be moved to quarantine": "실행 중인 전체 과정 비교는 복구 보관소로 옮길 수 없습니다.",
    "cannot be moved to quarantine while an experiment is active": "실험이 열려 있는 동안 저장 결과를 복구 보관소로 옮길 수 없습니다.",
...
_EN_DETAILS = {
    ...
    "active course comparison cannot be moved to quarantine": "A running course comparison cannot be moved to quarantine.",
    "cannot be moved to quarantine while an experiment is active": "Saved evidence cannot be moved to quarantine while an experiment is active.",
